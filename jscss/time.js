function showTime() { 
	...
	var currentTimeString = "Dear Yue:<br>"
        ...
        + "<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >执子之手  与子偕老</c>"; 
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----wuxia2001   2019-05-21</c>"; 
